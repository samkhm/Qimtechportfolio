...
export default function Sidebar({ activeSection, setActiveSection }) {
    ...
    const adminMenuItems = [
        ...
        { name: "Projects", icon: <BedIcon className="h-5 w-5" />, key: 'projects' },
        { name: "Services", icon: <Receipt className="h-5 w-5" />, key: 'services' },
        { name: "Skills", icon: <Receipt className="h-5 w-5" />, key: 'skills' },
        { name: "Hobbies", icon: <Receipt className="h-5 w-5" />, key: 'hobbies' },
        { name: "Testimonials", icon: <Receipt className="h-5 w-5" />, key: 'testimonials' },
    ...
    return (
        <>
            ...
            <div className="md:hidden p-4 w-fit h-fit absolute ">
